            ...
            <div class="page-inner py-5">
                <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                    <div>
                        ...
                        <h5 class="text-white op-7 mb-2">SD Negeri Batursari 5</h5>
                    </div>
                    <div class="ml-md-auto py-2 py-md-0">
                        <a href="{{ url('buku/list') }}" class="btn btn-white btn-border btn-round mr-2">Buku</a>
                        <a href="{{ url('pengunjung') }}" class="btn btn-secondary btn-round">Peminjam</a>
                    </div>
                </div>
            </div>
        </div>
